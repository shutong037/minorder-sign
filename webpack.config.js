...
module.exports = {
  ...
  output: {
    filename: "js/[name].[chunkhash:8].js", // js 输出到 dist/js/xxx
    publicPath: "/mini/", // 公用的公共路径 
    path: path.resolve(__dirname, "dist/mini") // 输出目录为 dist
  ...
  plugins: [
    ...
    new MiniCssExtractPlugin({
      ...
      chunkFilename: "css/common.[chunkhash:8].css" // 针对公共样式的文件名
    }),
  ],
};
